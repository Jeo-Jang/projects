...
- **persistence.md** — for RLS rules and database identity mapping  
- **chat-systems.md** — for how auth guards interact with chat systems  
- **agents.md** — for identity-aware agent execution  
- **patterns.md** — for authentication gate as a design pattern  
