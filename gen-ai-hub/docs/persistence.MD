...
- **authentication.md** → How identity maps into RLS  
- **chat-systems.md** → Message processing & DB integration  
- **agents.md** → RAG/agent flows using stored data  
- **heuristics.md** → How token usage affects CO₂ metrics  
